...
try:
    from dreamspace.cli.display import ImageDisplay, FrameAnimator, LoopMode, load_png_frames
...
def parse_arguments() -> argparse.Namespace:
    ...
    parser.add_argument(
        "directory", type=str,
        help="Directory containing PNG files to animate"
    )
    
    # Animation options
    parser.add_argument(
        "--fps", type=int, default=24,
        help="Animation frames per second (default: 24)"
    )
    
    parser.add_argument(
        "--loop-mode", type=str, choices=["ping-pong", "forward"], default="ping-pong",
...
def main():
    ...
    loop_mode = LoopMode.PING_PONG if args.loop_mode == "ping-pong" else LoopMode.FORWARD
    ...
    try:
        ...
        while running:
            ...
            clock.tick(60)  # Run at 60 FPS for smooth display, animator controls frame timing
            frame_count += 1
